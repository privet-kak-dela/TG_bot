...
def send_welcome(message):
    welcome_text = (
        "Привет, хозяин! Я ваш Telegram бот.\n"
        "Доступные команды:\n"
        "/start - вывод всех доступных команд\n"
        "/model - выводит название используемой языковой модели\n"
        "/clear - очистить историю диалога\n"
        "Отправьте любое сообщение, и я отвечу с помощью LLM модели, но я маленький и глупенький, не ругайся:)"
    )
...
def clear_context(message):
    ...
    if user_id in user_contexts:
        ...
        bot.reply_to(message, "История диалога очищена. Здравствуйте, знакомы?")
    else:
